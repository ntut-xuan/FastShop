...
def test_get_with_authorized_account_should_respond_content_of_profile_html(
...
def test_get_with_unauthorized_account_should_respond_content_of_login_html(
    client: FlaskClient,
) -> None:
